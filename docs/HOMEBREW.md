...
> longer be available. This fork publishes macOS builds as `.zip` assets on
> [GitHub Releases](https://github.com/neekolascmd/noop/releases). Treat the notes below as
