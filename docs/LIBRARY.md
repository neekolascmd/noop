...
| `ouraRawHistory` | bounded exact Oura history TLVs, validated time anchors, and durable decoder revisions for offline re-decoding | local `archiveId`; exact-record unique index |
