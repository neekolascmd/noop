...
| Oura | Local BLE | **Implemented / experimental** — protocol package and platform sources exist; production hardware validation remains incomplete | Ring generation, firmware, host, and current availability are unrecorded |
