...
| Oura / Fitbit / Garmin | Offline wellness-export import | **Implemented** with shared Swift/Kotlin fixtures. Oura API-shaped JSON and sleep-period CSV import the official 5-minute phase string as a chronological hypnogram when present; this verifies parsers, not current vendor hardware or export apps | Capture a fresh, privacy-redacted Oura export containing `sleep_phase_5_min`, record the app/export version, and use it as the reference timeline for direct-BLE stage qualification |
