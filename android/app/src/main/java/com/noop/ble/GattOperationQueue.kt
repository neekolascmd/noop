...
/** Required HR setup failures recover the link; optional telemetry must never take working HR down. */
internal fun gattOperationFailureAction(requiredForHr: Boolean): GattOperationFailureAction =
    if (requiredForHr) GattOperationFailureAction.RECONNECT else GattOperationFailureAction.SKIP_OPTIONAL
